        ...
        <div class="flex flex-col gap-8">
            <div class="p-6">
                    ...
                    <ul class="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 text-gray-600">
                        <?php if (!empty($sermao['data'])): ?>
                            <li class="flex items-center">
                                ...
                                <span><?= date("d.m.y", strtotime($sermao['data'])) ?></span>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (!empty($sermao['pregador'])): ?>
                            <li class="flex items-center">
                                ...
                                <span><?= htmlspecialchars($sermao['pregador']) ?></span>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <?php if (!empty($sermao['midias'])): ?>
                    <div x-data="mediaPreview(<?= htmlspecialchars(json_encode($sermao['midias'])) ?>)" x-init="init()"
