...
<div class="bg-white shadow rounded-lg p-6 max-w-2xl mx-auto">
    ...
    <form method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="titulo" id="titulo" value="<?= htmlspecialchars($evento['titulo']) ?>" required
        ...
        <div>
            ...
            <textarea name="descricao" id="descricao" rows="4"
                class="w-full px-3 py-2 border rounded-md shadow-sm focus:ring focus:ring-blue-500 focus:border-blue-500"><?= htmlspecialchars($evento['descricao']) ?></textarea>
        </div>
        ...
        <div>
            ...
            <select name="status" id="status"
                ...
                <option value="em_andamento" <?= $evento['status'] === 'em_andamento' ? 'selected' : '' ?>>Em andamento
                </option>
            ...
            <div class="grid grid-cols-3 gap-4">
                <?php foreach ($midias as $m): ?>
                    <label class="flex flex-col items-center border rounded p-2 cursor-pointer hover:shadow">
                        ...
                        <span
                            class="text-xs mt-1 text-center w-full"><?= htmlspecialchars($m['nome_arquivo']) ?></span>
                    </label>
                <?php endforeach; ?>
            </div>
        </div>
